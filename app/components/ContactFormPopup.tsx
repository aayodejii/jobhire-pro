...
interface FormValues {
  ...
  reminderTime?: "1-week" | "2-weeks" | "1-month" | "3-months";
}
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // await axios.post("https://your-api-endpoint.com/submit", values);
            ...
            <div className="text-center py-8">
              {formik.values.commitment === "now" && calendarRedirecting ? (
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-gray-600">
                    We'll remind you in{" "}
                    {formik.values.reminderTime?.replace("-", " ")}. Our team
                      ...
                      {[
                        ...
                        >
                          <input
                            ...
                            value={option.value}
                            checked={
                              formik.values.reminderTime === option.value
                            }
                            onChange={formik.handleChange}
                            className="h-4 w-4 text-blue-600 focus:ring-blue-500"
                          />
